...
Button(root,text='Show Tables',command=showTable).pack()
labelText1 = StringVar()
labelText1.set('----')
Label(root,textvariable=labelText1,bg='cyan').pack()

labelText2 = StringVar()
labelText2.set('----')
Label(root,textvariable=labelText2,bg='indigo').pack()
...
labelText4.set('----')
Label(root,textvariable=labelText4,bg='green').pack()
...
labelText6.set('----')
Label(root,textvariable=labelText6,bg='orange').pack()
...
labelText8.set('----')
Label(root,textvariable=labelText8,bg='pink').pack()
